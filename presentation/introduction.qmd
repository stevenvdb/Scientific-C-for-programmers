...
- HPC (High Performance Computing):<br>
  ...
  part of the Vlaams Supercomputer Centrum (VSC ^[[VSCentrum.be](https://www.vscentrum.be/)])
...
- Ecosystem for scientific computing not as advanced as C/C++,<br>but efforts are under way
...
- Can be used as both a scripted or compiled language
