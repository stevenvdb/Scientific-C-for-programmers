...
## Virtual memory layout {.smaller background-color="lightgrey"}
...
- The provided code allocated memory at **each** iteration without ever freeing
  it
- This is a memory leak: for larger grids and/or more steps, you would run out
  of memory
...
## Common data structures {.smaller}
...
## Unions {.smaller background-color="lightgrey"}
